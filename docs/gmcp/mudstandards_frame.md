---
sidebar_label: mudstd.frame
---
# The ``mudstd.frame`` package
...
Sent by the client to notify the server of its capabilities. Should be send unsolicited after establishing the connection or as a response to a ``mudstd.window.query``
